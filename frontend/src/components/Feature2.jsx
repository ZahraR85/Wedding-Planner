...
const Features2 = () => {
  const features = [
    ...
    },
    {
      ...
      // description: 'Manage your guest RSVPs easily.',
      icon: (
        <img src={venue} alt="Guest List Icon" className="h-64 w-64 mx-auto" />
      ),
    },
    {
      // title: 'Guest List',
    ...
    },
    {
      ...
      // description: 'Manage your guest RSVPs easily.',
      icon: (
        <img src={budget} alt="Guest List Icon" className="h-64 w-64 mx-auto" />
      ),
    },
    {
      // title: 'Guest List',
  ...
  return (
    <div className="bg-[#FAF9F5] py-10 px-6">
      <h1
        className="text-2xl lg:text-3xl text-BgFont font-bold text-left mb-10"
        style={{ color: "#624e40" }}
      >
        Our Services
      </h1>
