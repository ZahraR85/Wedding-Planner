  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <section className="text-center mb-12">
        <h1 className="text-4xl font-bold text-BgFont">About Us</h1>
        <p className="text-lg text-BgFont mt-2">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-semibold text-BgFont">Our Story</h2>
        <p className="text-lg text-BgFont mt-4">
...
We believe that wedding planning should be a joyful experience, not a stressful one. That's why we’ve designed our services to make everything seamless, from budgeting to guest lists, so you can focus on what truly matters — celebrating your love.
      ...
      <section className="bg-[#e8dfcf] p-8 rounded-lg mb-12">
        <h2 className="text-3xl font-semibold text-BgFont">Our Mission</h2>
        <p className="text-lg text-BgFont mt-4">
      ...
      <section className="bg-customBg1 p-8 rounded-lg mb-12">
        <h2 className="text-3xl font-semibold text-BgFont">Why Choose Us</h2>
        <ul className="mt-4 text-lg text-BgFont">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-semibold text-BgFont">What Our Clients Say</h2>
        <div className="mt-6">
          <blockquote className="text-lg text-BgFont">
          ...
          <p className="text-BgFont mt-2">- Veronika</p>
        </div>
      </section>
    </div>
  );
