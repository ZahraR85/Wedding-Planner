      ...
      <table className="table-auto text-BgFont w-full border-collapse border border-BgFont">
        <thead>
          <tr>
            ...
            <th className="border border-BgFont px-2 sm:px-4 py-2 text-xs sm:text-base">Price (€/person)</th>
        ...
        <tbody>
          {features.map((feature) => (
            ...
            >
              <td className="border border-gray-300 px-2 sm:px-4 py-2 text-xs sm:text-base">{feature.name}</td>
              <td className="border border-gray-300 px-2 sm:px-4 py-2 text-xs sm:text-base">{feature.price} €</td>
